# Migration `20191220162753-bootstrap`

This migration has been generated by Jasopaum at 12/20/2019, 4:27:53 PM.
...
You can use a specific Photon built for this migration (20191220162753-bootstrap)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191220162753-bootstrap'
