# Migration `20191216145058-bootstrap`

This migration has been generated by Jasopaum at 12/16/2019, 2:50:58 PM.
...
You can use a specific Photon built for this migration (20191216145058-bootstrap)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191216145058-bootstrap'
