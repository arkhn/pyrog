# Migration `20191215155501-bootstrap`

This migration has been generated by Jasopaum at 12/15/2019, 3:55:01 PM.
...
You can use a specific Photon built for this migration (20191215155501-bootstrap)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191215155501-bootstrap'
