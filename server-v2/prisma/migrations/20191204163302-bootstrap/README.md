# Migration `20191204163302-bootstrap`

This migration has been generated by simonvadee at 12/4/2019, 4:33:02 PM.
...
You can use a specific Photon built for this migration (20191204163302-bootstrap)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191204163302-bootstrap'
