export const questions : any = [
    {
        ...
        "sections": [
                ...
                "mapping_items": [
                    {
                        ...
                        "text": "Indiquez quelle colonne contient nom de famille du patient. Nous avons proposé des suggestions de colonne contenant des noms de famille, vous pouvez affiner la recherche en renseignant des mots clefs. Choisissez la colonne qui convient.",
                    ...
                    },
                    {
                        ...
                        "text": "Précisez l'identifiant du patient, son numéro de sécurité sociale ou INSEE. Vous pouvez affiner la recherche avec des mots clefs tels que 'secu', 'insee', etc.",
            ...
            },
            {
                ...
                "mapping_items": [
                    {
                        "text": "On cherche désormais les informations sur le médecin ou praticien. Où se trouve son nom de famille.",
                    ...
                    {
                        "text": "On a besoin d'un identifiant. Pouvez-vous trouver la ou les colonne(s) qui stockent le numéro Adeli ou RPPS ou tout autre identifant pertinent ? Vous pouvez indiquez plusieurs colonnes s'il y a plusieurs identifiants, et utiliser des mots cledfs pour faciliter votre recherche.",
                        "fhir_attribute": "practitioner.identifier.value"
                    },
                    {
                        "text": "Indiquez en toute lettre le type d'identifiant (Exemple: Adeli, RPPS...)",
                        "fhir_attribute": "practitioner.identifier.type"
                    },
                    {
                        "text": "Où se trouve le téléphone du médecin ? Vous pouvez indiquer plusieurs colonnes si par exemple il y a une colonne pour les portables et une autres pour les téléphones fixes.",
                    ...
                    {
                        "text": "Peut-on trouver une colonne qui précise la spécialité du médecin ?",
