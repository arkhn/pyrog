...
export const availableResourceNames = [
    {type: "Clinical", subtype: "Medication & Immunization", name: "Immunization"},
    {type: "Clinical", subtype: "Medication & Immunization", name: "MedicationAdministration"},
    {type: "Clinical", subtype: "Medication & Immunization", name: "Medication"},
    {type: "Clinical", subtype: "Medication & Immunization", name: "MedicationStatement"},
    {type: "Clinical", subtype: "Medication & Immunization", name: "ImmunizationRecommendation"},
    {type: "Clinical", subtype: "Medication & Immunization", name: "MedicationDispense"},
    {type: "Clinical", subtype: "Medication & Immunization", name: "MedicationRequest"},
    ...
    {type: "Infrastructure", subtype: "Documents & Lists", name: "DocumentReference"},
    {type: "Infrastructure", subtype: "Documents & Lists", name: "DocumentManifest"},
    ...
    {type: "Infrastructure", subtype: "Information Tracking", name: "AuditEvent"},
    {type: "Infrastructure", subtype: "Information Tracking", name: "Provenance"},
    {type: "Infrastructure", subtype: "Information Tracking", name: "QuestionnaireResponse"},
    {type: "Infrastructure", subtype: "Information Tracking", name: "Questionnaire"},
    ...
    {type: "Conformance", subtype: "Operations Control", name: "SearchParameter"},
    {type: "Conformance", subtype: "Operations Control", name: "OperationDefinition"},
    {type: "Conformance", subtype: "Operations Control", name: "CapabilityStatement"},
