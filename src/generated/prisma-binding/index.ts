...
export interface Query {
    databases: <T = Array<Database | null>>(args: { where?: DatabaseWhereInput | null, orderBy?: DatabaseOrderByInput | null, skip?: Int | null, after?: String | null, before?: String | null, first?: Int | null, last?: Int | null }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> ,
    ...
    database: <T = Database | null>(args: { where: DatabaseWhereUniqueInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
    ...
    databasesConnection: <T = DatabaseConnection>(args: { where?: DatabaseWhereInput | null, orderBy?: DatabaseOrderByInput | null, skip?: Int | null, after?: String | null, before?: String | null, first?: Int | null, last?: Int | null }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> ,
...
export interface Mutation {
    ...
    updateDatabase: <T = Database | null>(args: { data: DatabaseUpdateInput, where: DatabaseWhereUniqueInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
    ...
    deleteDatabase: <T = Database | null>(args: { where: DatabaseWhereUniqueInput }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T | null> ,
    ...
    updateManyDatabases: <T = BatchPayload>(args: { data: DatabaseUpdateManyMutationInput, where?: DatabaseWhereInput | null }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> ,
    ...
    deleteManyDatabases: <T = BatchPayload>(args: { where?: DatabaseWhereInput | null }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> ,
...
export interface Subscription {
    database: <T = DatabaseSubscriptionPayload | null>(args: { where?: DatabaseSubscriptionWhereInput | null }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<AsyncIterator<T | null>> ,
...
export interface DatabaseCreateInput {
  name: String
  resources?: ResourceCreateManyWithoutDatabaseInput | null
}

export interface DatabaseCreateOneWithoutResourcesInput {
  create?: DatabaseCreateWithoutResourcesInput | null
  connect?: DatabaseWhereUniqueInput | null
}
...
export interface DatabaseSubscriptionWhereInput {
  AND?: DatabaseSubscriptionWhereInput[] | DatabaseSubscriptionWhereInput | null
  OR?: DatabaseSubscriptionWhereInput[] | DatabaseSubscriptionWhereInput | null
  NOT?: DatabaseSubscriptionWhereInput[] | DatabaseSubscriptionWhereInput | null
  mutation_in?: MutationType[] | MutationType | null
  updatedFields_contains?: String | null
  updatedFields_contains_every?: String[] | String | null
  updatedFields_contains_some?: String[] | String | null
  node?: DatabaseWhereInput | null
}

export interface DatabaseUpdateInput {
  name?: String | null
  resources?: ResourceUpdateManyWithoutDatabaseInput | null
}
...
export interface DatabaseUpdateOneRequiredWithoutResourcesInput {
  create?: DatabaseCreateWithoutResourcesInput | null
  connect?: DatabaseWhereUniqueInput | null
  update?: DatabaseUpdateWithoutResourcesDataInput | null
  upsert?: DatabaseUpsertWithoutResourcesInput | null
}
...
export interface DatabaseWhereInput {
  AND?: DatabaseWhereInput[] | DatabaseWhereInput | null
  OR?: DatabaseWhereInput[] | DatabaseWhereInput | null
  NOT?: DatabaseWhereInput[] | DatabaseWhereInput | null
  id?: ID_Input | null
  id_not?: ID_Input | null
  id_in?: ID_Output[] | ID_Output | null
  id_not_in?: ID_Output[] | ID_Output | null
...
export interface ResourceCreateManyWithoutDatabaseInput {
  create?: ResourceCreateWithoutDatabaseInput[] | ResourceCreateWithoutDatabaseInput | null
...
export interface ResourceUpdateInput {
  ...
  database?: DatabaseUpdateOneRequiredWithoutResourcesInput | null
}
...
export interface ResourceUpdateManyWithoutDatabaseInput {
  ...
  update?: ResourceUpdateWithWhereUniqueWithoutDatabaseInput[] | ResourceUpdateWithWhereUniqueWithoutDatabaseInput | null
  ...
  upsert?: ResourceUpsertWithWhereUniqueWithoutDatabaseInput[] | ResourceUpsertWithWhereUniqueWithoutDatabaseInput | null
}
...
export interface ResourceWhereInput {
  ...
  attributes_some?: AttributeWhereInput | null
  attributes_none?: AttributeWhereInput | null
  database?: DatabaseWhereInput | null
}
...
export interface DatabaseSubscriptionPayload {
  ...
  node?: Database | null
  updatedFields?: Array<String> | null
  previousValues?: DatabasePreviousValues | null
}
