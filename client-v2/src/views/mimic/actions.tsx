...
export const changeTypeMimic = (
  ...
  return (dispatch: any, getState: any) => {
    Promise.all([
      dispatch(
        fetchBetaRecommendedColumns(fhirAttribute, type, head_table, mot_clef)
      )
    ]).then((response: any) => {
...
export const changeMotClefMimic = (
  fhirAttribute: string,
  type: string,
  head_table: string,
  mot_clef: string
...
export const updateMotClefMimic = (
  fhirAttribute: string,
  mot_clef: string
): IAction => {
  return {
