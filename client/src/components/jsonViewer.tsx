...
> {
  ...
  static genNode(_key: string, _obj: any): ITreeNode {
    const hasChildren =
      !isNullOrUndefined(_obj) &&
      (_obj instanceof Array || _obj instanceof Object);
    const result = {
      id: this.getId(),
    ...
    return this.state.isBroken ? (
      ...
      >
        ...
        <Tab
          id="stringview"
          title="Plain View"
          panel={<JSONPretty id="json-pretty" json={this.state.renderJson} />}
        />
        <Tabs.Expander />
        <Button />
        <Button />
